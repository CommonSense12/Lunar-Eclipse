    ...
    local RayfieldLibrary = {
        ...
        Theme = {
            Default = {
                TextFont = "Default", -- Default will use the various font faces used across Rayfield
                TextColor = Color3.fromRGB(136, 8, 8),
    
                Background = Color3.fromRGB(210, 43, 43),
                Topbar = Color3.fromRGB(136, 8, 8),
                Shadow = Color3.fromRGB(20, 20, 20),
                ...
                TabBackground = Color3.fromRGB(116, 33, 158),
                TabStroke = Color3.fromRGB(45, 11, 117),
                TabBackgroundSelected = Color3.fromRGB(169, 49, 234),
                TabTextColor = Color3.fromRGB(240, 240, 240),
                SelectedTabTextColor = Color3.fromRGB(50, 50, 50),
    
                ElementBackground = Color3.fromRGB(24, 5, 36),
                ElementBackgroundHover = Color3.fromRGB(14, 3, 21),
                SecondaryElementBackground = Color3.fromRGB(24, 5, 36), -- For labels and paragraphs
                ElementStroke = Color3.fromRGB(110, 43, 172),
                SecondaryElementStroke = Color3.fromRGB(24, 5, 36), -- For labels and paragraphs
    
                SliderBackground = Color3.fromRGB(144, 75, 171),
                SliderProgress = Color3.fromRGB(48, 22, 79),
                SliderStroke = Color3.fromRGB(52, 15, 95),
    
                ToggleBackground = Color3.fromRGB(30, 30, 30),
                ToggleEnabled = Color3.fromRGB(62, 15, 100),
                ToggleDisabled = Color3.fromRGB(100, 100, 100),
                ToggleEnabledStroke = Color3.fromRGB(40, 19, 65),
                ToggleDisabledStroke = Color3.fromRGB(125, 125, 125),
                ToggleEnabledOuterStroke = Color3.fromRGB(79, 39, 125),
    ...
    local Rayfield =  game:GetObjects("rbxassetid://12560849915")[1]
    ...
    local RayfieldLibrary = {
        ...
        Theme = {
            Default = {
                ...
                TabBackground = Color3.fromRGB(139, 0, 0),
                TabStroke = Color3.fromRGB(136, 8, 8),
                TabBackgroundSelected = Color3.fromRGB(220, 20, 60),
                TabTextColor = Color3.fromRGB(240, 240, 240),
                SelectedTabTextColor = Color3.fromRGB(50, 50, 50),
    
                ElementBackground = Color3.fromRGB(128, 0, 32),
                ElementBackgroundHover = Color3.fromRGB(154, 42, 42),
                SecondaryElementBackground = Color3.fromRGB(123, 24, 24, -- For labels and paragraphs
                ElementStroke = Color3.fromRGB(210, 43, 43),
                SecondaryElementStroke = Color3.fromRGB(123, 24, 24), -- For labels and paragraphs
    
                SliderBackground = Color3.fromRGB(210, 43, 43),
                SliderProgress = Color3.fromRGB(136, 8, 8),
                SliderStroke = Color3.fromRGB(128, 0, 32),
    
                ToggleBackground = Color3.fromRGB(210, 43, 43),
                ToggleEnabled = Color3.fromRGB(136, 8, 8),
                ToggleDisabled = Color3.fromRGB(128, 0, 32),
                ToggleEnabledStroke = Color3.fromRGB(165, 42, 42),
                ToggleDisabledStroke = Color3.fromRGB(123, 24, 24),
                ToggleEnabledOuterStroke = Color3.fromRGB(123, 24, 24),
                ToggleDisabledOuterStroke = Color3.fromRGB(123, 24, 24),
    ...
    return RayfieldLibrary
                ToggleDisabledStroke = Color3.fromRGB(139, 0, 0),
                ToggleEnabledOuterStroke = Color3.fromRGB(165, 42, 42),
                ToggleDisabledOuterStroke = Color3.fromRGB(165, 42, 42),--[[
    ...
    local RayfieldLibrary = {
        ...
        Theme = {
            ...
            Light = {
                TextFont = "Default",  -- Default will use the various font faces used across Rayfield
                TextColor = Color3.fromRGB(128, 0, 32),
    
                Background = Color3.fromRGB(210, 43, 43),
                Topbar = Color3.fromRGB(136, 8, 8),
                Shadow = Color3.fromRGB(210, 43, 43),
    
                NotificationBackground = Color3.fromRGB(20, 20, 20),
                NotificationActionsBackground = Color3.fromRGB(230, 230, 230),
    
                TabBackground = Color3.fromRGB(210, 43, 43),
                TabStroke = Color3.fromRGB(128, 0, 32),
                TabBackgroundSelected = Color3.fromRGB(136, 8, 8),
                TabTextColor = Color3.fromRGB(240, 240, 240),
                SelectedTabTextColor = Color3.fromRGB(50, 50, 50),
    
                ElementBackground = Color3.fromRGB(210, 43, 43),
                ElementBackgroundHover = Color3.fromRGB(128, 0, 32),
                SecondaryElementBackground = Color3.fromRGB(136, 8, 8), -- For labels and paragraphs
                ElementStroke = Color3.fromRGB(136, 8, 8),
                SecondaryElementStroke = Color3.fromRGB(136, 8, 8),  --For labels and paragraphs
    
                SliderBackground = Color3.fromRGB(210, 43, 43),
                SliderProgress = Color3.fromRGB(128, 0, 32),
                SliderStroke = Color3.fromRGB(136, 8, 8),
    
                ToggleBackground = Color3.fromRGB(210, 43, 43),
                ToggleEnabled = Color3.fromRGB(136, 8, 8),
                ToggleDisabled = Color3.fromRGB(128, 0, 32),
                ToggleEnabledStroke = Color3.fromRGB(136, 8, 8),
                ToggleDisabledStroke = Color3.fromRGB(128, 0, 32),
                ToggleEnabledOuterStroke = Color3.fromRGB(136, 8, 8),
                ToggleDisabledOuterStroke = Color3.fromRGB(136, 8, 8),
    
                InputBackground = Color3.fromRGB(210, 43, 43),
                InputStroke = Color3.fromRGB(128, 0, 32),
                PlaceholderColor = Color3.fromRGB(128, 0, 32)
            }
        }
    }
    ...
    return RayfieldLibrary
                ...
                InputBackground = Color3.fromRGB(136, 8, 8),
                InputStroke = Color3.fromRGB(165, 42, 42),
                PlaceholderColor = Color3.fromRGB(139, 0, 0)
            },
            Light = {
                TextFont = "Gotham",  -- Default will use the various font faces used across Rayfield
                TextColor = Color3.fromRGB(50, 50, 50), -- i need to make all text 240, 240, 240 and base gray on transparency not color to do this
